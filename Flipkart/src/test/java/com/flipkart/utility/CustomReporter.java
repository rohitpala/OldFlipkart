...
public class CustomReporter extends CustomReporterListener {
	...
	private void startResultSummaryTable(String style) { 
		...
		m_out.println("<tr><td colspan='5'>Overall test suite completion : <b>"
				...
				+ sdf.format(date) + "</b><br/> Browser : <b>"+Init.browser+"<t></t>"
				+ Init.browserVersion +  "</b><br/>OS: <b>"
	...
	protected void endHtml(PrintWriter out) {
		out.println("<tr bgcolor='SkyBlue'><td align='right' colspan='5'><center><b><i>Report customized by Kiwi QA </i><b><center></center></b></b></center></td></tr>");
